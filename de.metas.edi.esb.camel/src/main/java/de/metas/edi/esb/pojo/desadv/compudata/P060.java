...
public class P060 implements Serializable
{
	...
	public String getGrainNummer()
	{
		return grainNummer;
	}

	public void setGrainNummer(String grainNummer)
	{
		this.grainNummer = grainNummer;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((grainNummer == null) ? 0 : grainNummer.hashCode());
	...
	public boolean equals(Object obj)
	{
		...
		if (grainNummer == null)
		{
			if (other.grainNummer != null)
				return false;
		}
		else if (!grainNummer.equals(other.grainNummer))
			return false;
		if (hierachSSCC == null)
		{
